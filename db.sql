...
-- Database: `tubes`
--
CREATE DATABASE IF NOT EXISTS `tubes_fix` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tubes_fix`;
...
CREATE TABLE `user` (
  ...
  `role` enum('donatur','petugas','admin') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `status` enum('inactive','active') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `address` text NOT NULL,
